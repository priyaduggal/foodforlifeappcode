...
login_password:any;
  constructor(private fb: Facebook, private googlePlus: GooglePlus,private globalFooService: GlobalFooService, public api:ApiService, public router:Router,private common: CommonService) {
